...
<div style="width: 40%; margin: auto;">
	<div style="text-align: center;">
		...
		<form name="frmUser" method="post" action="member/register" enctype="multipart/form-data">
			<table style="width: 100%">
				...
				<tr>
					...
					<td>
						<input type="file" name="pics" id="filename">
					</td>
				</tr>
				...
				<tr style="border-top: 0px solid;">
					...
					<input type="button" value="가입하기" onclick='validForm()'>
					<input type="reset" value="다시쓰기">
					<input type="button" value="홈으로" onclick='location.href="./"'></td>
				</tr>
				...
				if(xhr.status == 200) {
					...
					document.querySelector('#val_check').addEventListener('click', function() {
						...
						if(insertVal == data.num) {
							...
							document.getElementById('insertVal').readOnly = true;
						} else {
